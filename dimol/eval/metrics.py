...
# rdkit is used across the whole module, so it is imported at the top; nltk /
# Levenshtein / fcd are imported lazily inside their functions so that the module
# can be read without those packages. Training and generation do not import this
# module (see dimol/eval/report.py).
